...
class PdfReportService {
        ...
        children: [
          pw.Column(
            ...
            children: [
              ...
              pw.Text(
                isFrench ? 'Plateforme - Rapport de Scan Podologique' : 'Platform - Podiatric Scan Report',
    ...
    return pw.Container(
      ...
      child: pw.Row(
        ...
        children: [
          pw.Text(
            isFrench 
                ? 'Genere par SOLOL-B2B Plateforme - ${DateFormat('dd/MM/yyyy HH:mm').format(DateTime.now())}'
                : 'Generated by SOLOL-B2B Platform - ${DateFormat('MM/dd/yyyy HH:mm').format(DateTime.now())}',
  ...
  static Future<void> printReport({
    ...
    await Printing.layoutPdf(
      ...
      name: 'SOLOL_B2B_${patient.fullName.replaceAll(' ', '_')}_${DateFormat('yyyyMMdd').format(session.createdAt)}.pdf',
    );
  }
  ...
  static Future<void> sharePdf({
    ...
    await Printing.sharePdf(
      bytes: pdfData,
      filename: 'SOLOL_B2B_${patient.fullName.replaceAll(' ', '_')}_${DateFormat('yyyyMMdd').format(session.createdAt)}.pdf',
    );
  }
}
